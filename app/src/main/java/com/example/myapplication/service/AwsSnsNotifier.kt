...
class AwsSnsNotifier {
    ...
    private val accessKey = "YOUR_AWS_ACCESS_KEY"
    private val secretKey = "YOUR_AWS_SECRET_KEY"
    private val topicArn = "YOUR_TOPIC_ARN" // or use phone number/email directly
